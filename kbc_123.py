...
class Quiz:
	...
	def buttons(self):
		...
		width=10,bg="red",fg="blue",font=("ariel",16,"bold"))
		...
		width=5,bg="pink", fg="blue",font=("ariel",16," bold"))
	...
	def display_title(self):
		...
		title = Label(gui, text="@@@@@@@@@@@WELCOME TO KBC GAME@@@@@@@@@@",
